...
class Products(db.Model):
    ...
    def __init__(self, name, shoetype, condition, description, size, gender, price, filename, contact, accesscode):
        self.name = name
...
def postproduct():
    ...
    if form.validate_on_submit():
        ...
        new_product = Products(name, shoetype, condition, description, size, gender, price, filename, contact, accesscode)
...
@app.route('/shop/thanksforshopping', methods = ['GET', 'POST'])
def thanksforshopping():
    return render_template('thanksforshopping.html')
